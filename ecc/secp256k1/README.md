...
This crate provides `secp256k1` elliptic curve implementation with `halo2wrong` backend. Intention of this crate is to generate circuit witnesses for ECDSA signature verification.
